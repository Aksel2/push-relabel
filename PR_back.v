...
Module PR (T:T).
    ...
    Proof.
        ...
        intros. destruct (equal v t), (equal v s); subst.
        + inversion H.
        + inversion H.
        + inversion H.
        + simpl in H. destruct_guard_in H.
    ...
    Proof.
        ...
        destruct (equal v t), (equal v s); subst.
        + clear H. right. auto.
        + clear H. right. auto.
        + clear H. right. auto.
        + simpl in H. destruct_guard_in H.
    ...
    destruct fn as [[[[vs es] c] s] t]. intros. unfold gpr_trace in H2.
        ...
        - destruct H2; split; auto. destruct H9. split; auto.
        destruct H10. rewrite NMap.FindReplaceEq in H10. split; auto.
        (* rewrite NMap.FindReplaceNeq in H11. *)
